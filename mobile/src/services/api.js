...
export const api = {
  ...
  reminderRules: (householdId) => request(`/households/${householdId}/notifications/rules`),
  ...
  markNotificationRead: (householdId, notificationId) => request(`/households/${householdId}/notifications/${notificationId}/read`, { method: "PATCH" }),
